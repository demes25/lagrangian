...
- Domain - a storage type which encodes a "domain" - i.e. a collection of points. This type holds the associated coordinate ranges, discretization step sizes, and Geometry (see #typedefs). 
...
- SpatialKernel - a keras Model subclass utilizing the U-Net architecture noted above. Instances of this type will act as our proposed solutions.
